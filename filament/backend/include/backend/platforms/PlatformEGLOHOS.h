...
#ifndef TNT_FILAMENT_BACKEND_OPENGL_OPENGL_PLATFORM_EGL_OHOS_H
#define TNT_FILAMENT_BACKEND_OPENGL_OPENGL_PLATFORM_EGL_OHOS_H
 ...
 * EGL on OHOS. It adds OHOS streaming functionality to PlatformEGL.
 */
class PlatformEGLOHOS : public PlatformEGL {
public:

    PlatformEGLOHOS() noexcept;
    ~PlatformEGLOHOS() noexcept override;
...
protected:
    ...
    /**
     * Returns the OHOS SDK version.
     * @return OHOS SDK version.
     */
    ...
    /**
     * Set the presentation time using `eglPresentationTimeOHOS`
...
private:
    int mOSVersion;
    ExternalStreamManagerOHOS& mExternalStreamManager;
};

} // namespace filament::backend

#endif // TNT_FILAMENT_BACKEND_OPENGL_OPENGL_PLATFORM_EGL_OHOS_H
